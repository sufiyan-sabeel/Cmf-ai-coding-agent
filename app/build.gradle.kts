...
val privacyPolicyUrl = providers.gradleProperty("privacyPolicyUrl").orNull
    ?: "https://github.com/sufiyan-sabeel/Cmf-ai-coding-agent/blob/main/PRIVACY.md"
...
val appUpdateManifestUrl =
    "https://github.com/sufiyan-sabeel/Cmf-ai-coding-agent/releases/latest/download/mobile-harness-update.json"
...
tasks.register("playReadinessCheck") {
    group = "verification"
    description = "Checks configuration required before uploading a CMF Coding Agent Play bundle."
    doLast {
