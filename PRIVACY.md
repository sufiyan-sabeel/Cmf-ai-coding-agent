# Mobile CMF Coding Agent Privacy Policy

**Effective date:** August 24, 2026

Mobile CMF Coding Agent is a local-first Android development workspace. This policy explains what information the app handles, where it is stored, and when information leaves the device.

## Information handled by the app

Mobile CMF Coding Agent may handle the following information when you choose to provide it:
...
Mobile CMF Coding Agent does not currently include advertising or analytics SDKs and does not operate a first-party user account system.
...
Mobile CMF Coding Agent does not sell personal information. It does not send projects or conversations to the CMF Coding Agent developer unless you explicitly share them, submit diagnostics, or use a future opt-in backup or support feature.
...
- **Install packages:** Submit an Android APK built in your selected project to Android's system installer. Android asks you to allow this source and confirm installation; CMF Coding Agent cannot silently install apps.
...
Local information remains on the device until you delete the relevant project, clear it from the app, or uninstall CMF Coding Agent. Uninstalling the app removes its private local data according to Android's behavior.
...
CMF Coding Agent uses app-private Android storage, Android Keystore-backed credential encryption, HTTPS for external services, and checksum verification for supported runtime downloads. No system can guarantee complete security. Code executed inside the local Linux environment should be limited to projects and dependencies you trust.

## Children

CMF Coding Agent is a developer tool and is not directed to children under 13. The app does not knowingly collect personal information from children.

## Changes to this policy

This policy may be updated as CMF Coding Agent changes. Material changes will be reflected by updating the effective date and publishing the revised policy at the same public URL.

## Contact

For privacy questions or requests, open an issue at [github.com/sufiyan-sabeel/Cmf-ai-coding-agent/issues](https://github.com/sufiyan-sabeel/Cmf-ai-coding-agent/issues).
