...
Account-deletion and Play Billing requirements apply only if CMF Coding Agent later introduces first-party accounts or sells digital subscriptions in the app.
...
```bash
export MH_UPLOAD_STORE_FILE="/absolute/path/cmf-coding-agent-upload.jks"
...
./gradlew \
  ...
  -PprivacyPolicyUrl=https://github.com/sufiyan-sabeel/Cmf-ai-coding-agent/blob/main/PRIVACY.md \
